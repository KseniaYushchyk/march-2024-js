...
for (const course of coursesAndDurationArray) {
    let block = document.createElement('div');
    block.innerText = `Title: ${course.title}, month duration: ${course.monthDuration}`;
    document.body.appendChild(block);
}
//
//     - Є масив
...
for (const course of coursesArray) {
    let contentOfCourse = document.createElement('div');
    let divForTitle = document.createElement('div');
    let titleOfCourse = document.createElement('h3');
    ...
    monthDuration.classList.add('with-month');
    hourDuration.classList.add('with-hour');
    duration.classList.add('flex');

    contentOfCourse.append(divForTitle, titleOfCourse);
    duration.append(monthDuration, hourDuration);
    contentOfCourse.append(duration);

    for (const module of course.modules) {
        let moduleDiv = document.createElement('div');
        moduleDiv.innerText = module;
        contentOfCourse.appendChild(moduleDiv);
    }

    document.body.appendChild(contentOfCourse);
}
